...
public class Account extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel17.setText(" Transfer Money - Net Banking");
        ...
        jPanel1.setBounds(12, 295, 286, 290);
        ...
        jPanel2.setBounds(316, 295, 316, 233);
        ...
        jButton2.setBounds(500, 600, 95, 37);
        ...
        jButton1.setBounds(340, 600, 87, 37);
        ...
        jButton4.setBounds(500, 540, 94, 40);
        ...
        jLabel13.setBounds(60, 20, 556, 200);
        getContentPane().add(jLabel16);
        jLabel16.setBounds(0, 0, 0, 0);

        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/background.jpg"))); // NOI18N
        getContentPane().add(jLabel19);
        jLabel19.setBounds(0, 0, 700, 670);
...
String gen=TF5.getText();
String mob=TF6.getText();
String adhar=TF7.getText();
String bal=TF8.getText();
String pin=TF9.getText();
String nom=TF10.getText();
String card=TF11.getText();
String doj=TF12.getText();
int a=JOptionPane.showConfirmDialog(null,"Do you want to CREATE a NEW ACCOUNT ?");
if(a==JOptionPane.YES_OPTION){
try{
    Class.forName("java.sql.DriverManager");
    Connection con=DriverManager.getConnection(DB,"root","1234");
    Statement stmt=con.createStatement();
    String qr="insert into account values('"+accno+"','"+name+"','"+Fname+"','"+dob+"','"+addr+"','"+gen+"','"+mob+"','"+adhar+"','"+bal+"','"+pin+"','"+nom+"','"+card+"','"+doj+"');";
    stmt.executeUpdate(qr);
    JOptionPane.showMessageDialog(null,"New Account is created successfully by "+name);
...
dispose();// TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        TF11.setText("");
        TF12.setText("");
        TF13.setText("");        // TODO add your handling code here:
    ...
    private void B3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B3ActionPerformed
        ...
        String accno=TF13.getText();
        String name,Fname,dob,addr,gen,mob,adhar,bal,pin,nom,card,doj;
        String qr="select Account_Number,Name,Father_Name,Date_Of_birth,"
        + "Address,Gender,Mobile_Number,Adhar_Card_Number,Balance"
        + ",Pin_Number,Nomination,Card_Number,Date_Of_Joining from"
        + " account where Account_Number ='"+accno+"';";
        try{
            Class.forName("java.sql.DriverManager");
            Connection con=DriverManager.getConnection(DB,"root","1234");
            Statement stmt=con.createStatement();
