...
public class Modify extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel18.setText("           Modify Account");
        ...
        jPanel2.setBounds(310, 300, 316, 233);
        ...
        jButton4.setBounds(520, 540, 90, 40);
        ...
        jButton6.setBounds(340, 540, 89, 40);
        ...
        jLabel16.setBounds(0, 0, 640, 650);
...
// TODO add your handling code here:
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int a=JOptionPane.showConfirmDialog(null,"Do you want to MODIFY "
                + "your ACCOUNT detalis ?");
        if(a==JOptionPane.YES_OPTION){
            try{
                Class.forName("java.sql.DriverManager");
                Connection con=DriverManager.getConnection(DB,"root","1234");
                Statement stmt=con.createStatement();
                String qr="Update account SET "
                + "Name ='"+name+"',"
                + "Father_Name ='"+Fname+"',"
                + "Date_Of_birth ='"+dob+"',"
                + "Address ='"+addr+"',"
                ...
                JOptionPane.showMessageDialog(null,"Account is MODIFIED "
                        + "successfully");}
            catch(Exception e)
            {JOptionPane.showMessageDialog(null,e.getMessage());}}
